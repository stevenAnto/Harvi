...
import 'package:hive2/boxes.dart';
import 'package:hive2/transaction_dialog.dart';
...
class _TransactionPageState extends State<TransactionPage> {
  @override
  void dispose() {
    Hive.close(); //cierra Base de datos
  ...
  Widget buildContent(List<Transaction> transactions) {
    if (transactions.isEmpty) {
      ...
      final netExpense = transactions.fold<double>(
        0,
        (previousValue, transaction) => transaction.isExpensive
  ...
  Widget buildTransaction(
    ...
    final color = transaction.isExpensive ? Colors.red : Colors.green;
...
//insertar
  ...
  void editTransaction(
    ...
    transaction.isExpensive = isExpense;
